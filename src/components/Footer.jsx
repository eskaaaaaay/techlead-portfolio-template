        ...
        <div className="mb-8 p-4 sm:p-5 rounded-2xl border border-primary/20 bg-gradient-to-r from-primary/10 via-surface-card to-primary/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="text-center sm:text-left">
            ...
            <p className="text-[11px] font-mono text-text-muted mt-0.5">
              Open source engineering portfolio template with AI prompt blueprint
            </p>
          </div>
          ...
          <div className="flex items-center gap-2.5 shrink-0">
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-surface border border-border/60 hover:border-primary-light/40 text-text-secondary hover:text-text-primary text-xs font-mono transition-all duration-300 hover:shadow-lg hover:shadow-primary/10"
            >
              <GithubIcon size={14} />
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-surface border border-border/60 hover:border-primary-light/40 text-text-secondary hover:text-text-primary text-xs font-mono transition-all duration-300 hover:shadow-lg hover:shadow-primary/10"
            >
